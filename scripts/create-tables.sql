...
-- Service providers can be viewed by everyone, but only updated by owner
...
-- Requests can be viewed by client and provider involved
...
-- Messages can be viewed by sender and receiver
